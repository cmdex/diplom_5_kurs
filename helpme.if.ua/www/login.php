    ...
    <div class="content-login-form">
        ...
        <div id="comment-wrapper" class="box">
            ...
            <div id="login-form" class="login-form">
                ...
                <div id="respond">
                    <h3 id="reply-title">Вхід</h3>

                    <form action="php/logging/testreg.php" method="post" id="loginform">
                        <p class="login-notes"> Якщо ви ще не зареєстровані, пройдіть будь ласка <a
                                href="registration.php">реєстрацію</a>.</p>

                        <p class="login-form-author">
                        ...
                        <?php
                        //якщо введено неправильний логін або пароль
                        if ($_SESSION['bad_login'] == "yes") {
                            echo "<p class='login-notes'>Вибачте, але введений Вами логін або пароль - невірний!</p>";
                            $_SESSION['bad_login'] = "no";
                            //якщо не заповнено поля
                        ...
                        ?>
                        <p class="form-submit">
                            <input name="submit" type="submit" id="submit" value="Ввійти"/>
                        </p>
                    </form>
                </div>
                <!-- #respond -->
