...
<div class="content-account-form">	
		...
		<div id="addpostform" class="addpostform">
			...
			<div id="respond">
						...
						<form action="php/add_project.php" method="post" id="loginform">
							<p class="login-notes"> Ви можете описати свій проект будь якими словами, а також прикріпити фото, відео або ж аудіо</p>
	...
	<div id='content-add'>
		...
		<!-- modal content -->
		<div id="content-foto">
            <form action="php/upload.php" method="post" id="loginform">
			<h3>Додати фото</h3>
                <p class="addpost-form-photo">
                    ...
                    <input name="submit" type="file" id="submit" value="Додати фото" />
                </p>
		...
		<div id="content-audio">
			<h3>Додати аудіо</h3>
                            <p class="addpost-form-audio">
								...
								<input id="audio-artist" name="audio-artist" type="text" value="" size="30" aria-required='true' />
                                <label for="audio-treck">Назва пісні</label>
								<input id="audio-treck" name="audio-treck" type="text" value="" size="30" aria-required='true' />
                                <label for="audio-album">Назва альбому</label>
								<input id="audio-album" name="audio-album" type="text" value="" size="30" aria-required='true' />
...
<div class="site-generator-wrapper">
	<center><div class="site-generator">Design by <a href="http://bobrja.if.ua/">bobrja</a>.</div></center>
	<ul class="social">
